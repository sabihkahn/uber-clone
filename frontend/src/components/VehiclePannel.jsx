...
const VehiclePannel = ({ setvehiclepannelOpen, setconfirmRidepannel }) => {
  return (
    <>
      ...
      <div onClick={() => { setconfirmRidepannel(true) }} className='flex border-2 border-amber-50 active:border-black mb-2  rounded-xl w-full p-3  items-center justify-between'>

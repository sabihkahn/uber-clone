...
const VehiclePannel = ({setvehiclepannelOpen}) => {
  return (
    <>
    <h3 className='p-3 text-center absolute top-0 w-full' onClick={()=>{setvehiclepannelOpen(false)}}> <i className="ri-arrow-down-wide-line"></i></h3>
        <h3 className='text-xl mb-5 font-semibold'>Choose a vehicle </h3>
        <div className='flex border-2 border-amber-50 active:border-black mb-2  rounded-xl w-full p-3  items-center justify-between'>
          <img className='h-12' src="https://swyft.pl/wp-content/uploads/2023/05/how-many-people-can-a-uberx-take.jpg" alt="" />
          <div className='w-1/2 ml-2'>
            <h4 className='font-medium text-base'>Ubergo <span><i className="ri-user-fill"></i> 4</span></h4>
            <h5 className='font-medium text-sm'>3 mins away</h5>
            <p className='font-medium text-xs text-gray-800'>affordable compact rides</p>
          </div>
        ...
        <div className='flex border-2 border-amber-50 active:border-black mb-2  rounded-xl w-full p-3  items-center justify-between '>
          ...
          <div className='w-1/2 ml-2'>
            ...
            <p className='font-medium text-xs text-gray-800'>affordable Motor-cycle rides</p>
          </div>
        ...
        <div className='flex border-2 border-amber-50 active:border-black mb-2  rounded-xl w-full p-3  items-center justify-between'>
          ...
          <div className='w-1/2 ml-2'>
            ...
            <p className='font-medium text-xs text-gray-800'>affordable auto rides</p>
          </div>
